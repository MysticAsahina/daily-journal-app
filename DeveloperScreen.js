  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.Description}>deshadespa@gmail.com - Back-End Developer</Text>
        <Text style={styles.Description}>MysticAsahina@gmail.com - Front-End Developer</Text>

        <Text style={styles.value}>Github:</Text>
        <Text style={styles.Description}>https://github.com/deshadespa-glitch - Back-End Developer</Text>
        <Text style={styles.Description}>https://github.com/MysticAsahina - Front-End Developer</Text>
      </View>
